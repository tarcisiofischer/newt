...
from gui.input_listeners.mouse_constants import MOUSE_BUTTON_PRESSED, \
...
class GameLikeInputListener(object):
    ...
    def __init__(self, main_window):
        ...
        update_camera = lambda *args, **kwargs: \
            self._move_helper.updateCamera(main_window)
